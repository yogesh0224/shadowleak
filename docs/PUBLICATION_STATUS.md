...
**Overall status:** **Pre-results on both tracks.** The original four model runs are complete and structurally verified but require independent human annotation. The separate solo pilot's new-model workflow has been triggered, but **successful execution, manual labels, and measured findings have not been verified**.  
...
| **B. New, separate solo exploratory pilot** (`shadowleak-solo-exploratory-v1`) | [Prospective pilot protocol and claim register](SOLO_EXPLORATORY_PROTOCOL_V1.md); dedicated [new-data execution workflow run 35455829180](https://github.com/yogesh0224/shadowleak/actions/runs/35455829180), triggered 2026-09-19 at commit `be5a414205ea400a3b31e5208cd98dddbc794dfd`. | **Execution triggered; completion and evidence hashes NOT verified.** 10 new synthetic records, 620 planned cases, one pinned model, no human labels or defense estimates yet. | Wait for the GitHub workflow to finish and inspect only the metadata/hash summary, privately preserve outputs, then independently manually label all successful new responses before inspecting condition/detector outputs. [Issue #13](https://github.com/yogesh0224/shadowleak/issues/13). |
...
| 2026-09-19 | Solo new-data execution infrastructure merged in [PR #15](https://github.com/yogesh0224/shadowleak/pull/15); a dedicated 620-case model run was [triggered on GitHub Actions](https://github.com/yogesh0224/shadowleak/actions/runs/35455829180) at immutable execution SHA `be5a414205ea400a3b31e5208cd98dddbc794dfd`. Run completion/artifacts/outcomes are NOT yet verified. |
