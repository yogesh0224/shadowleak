...
## F. Closest inference-time and context-dependent evaluation literature (publication update, 2026-09-19)

| Key | Source | What the source studies | Comparison boundary for ShadowLeak |
|---|---|---|---|
| shao2024privacylens | Shao et al., “PrivacyLens: Evaluating Privacy Norm Awareness of Language Models in Action,” NeurIPS 2024 D&B; https://papers.nips.cc/paper_files/paper/2024/hash/a2a7e58309d5190082390ff10ff3b2b8-Abstract-Datasets_and_Benchmarks_Track.html | Contextual privacy norms in communication settings and agent trajectories; measures privacy leakage and action helpfulness. | Inference-time privacy and helpfulness evaluation are established. ShadowLeak uses simpler single-turn synthetic records, not action-level contextual-integrity judgments. |
| debenedetti2024agentdojo | Debenedetti et al., “AgentDojo: A Dynamic Environment to Evaluate Prompt Injection Attacks and Defenses for LLM Agents,” NeurIPS 2024 D&B; https://arxiv.org/abs/2406.13352 | Interactive agent tasks, attacker-controlled tool content, security outcomes and legitimate-task utility. | ShadowLeak does not presently establish a separate tool-output or authorization boundary; its prompt-template evaluation should not be called an indirect prompt-injection benchmark. |
| alizadeh2025personaldata | Alizadeh et al., “Simple Prompt Injection Attacks Can Leak Personal Data Observed by LLM Agents During Task Execution,” arXiv 2025; https://arxiv.org/abs/2506.01055 | Personal-data disclosure in synthetic banking-agent tasks under prompt injection, including defense and task-utility effects. | Synthetic information, leakage and defense-utility trade-offs have prior empirical treatment. ShadowLeak should not claim these elements as firsts; its narrower comparison is about measurement of direct contextual disclosure. |
| sun2025casebench | Sun et al., “CASE-Bench: Context-Aware SafEty Benchmark for Large Language Models,” ICML 2025; https://proceedings.mlr.press/v267/sun25ab.html | Human judgments under varying safety contexts and the consequences of inappropriate refusal. | Context and authorization matter. ShadowLeak's existing four benign prompts cannot establish utility across realistic authorized sensitive-data workflows. |

**Publication-positioning qualification:** A narrow comparison of detector-derived versus adjudicated-human *paired defense-effect estimates* is a candidate question, not a verified first, a preregistered primary hypothesis, or a demonstrated empirical finding. See `docs/PUBLICATION_POSITIONING_V1.md`. A broader search for disclosure-specific measurement papers is still required before any novelty claim.
