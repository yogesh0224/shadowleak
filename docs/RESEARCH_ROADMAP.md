...
| 3. Annotation preparation, double labeling, adjudication | **Pooled packaging generated/tested; durable handoff and human labels pending** | Prepare private archive and two independent annotator copies [#6](https://github.com/yogesh0224/shadowleak/issues/6); complete independent human annotation and freeze gold labels [#7](https://github.com/yogesh0224/shadowleak/issues/7). |
