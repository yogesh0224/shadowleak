...
> **Publication progress (verified 2026-09-19):** The frozen primary and three replication model runs are complete and their **7,440 model-generation cases** have passed a metadata-only evidence audit (zero recorded generation failures). The original archives still require durable private preservation; pooled annotation IDs need correction before **independent double annotation and adjudication**. No gold-label leakage rate, defense-effect estimate, final manuscript, or publication is yet established.
>
> **Track the work:** [Current publication status](docs/PUBLICATION_STATUS.md) · [Publication roadmap](docs/RESEARCH_ROADMAP.md) · [Artifact audit and SHA-256 digests](docs/CONFIRMATORY_ARTIFACT_AUDIT_2026-09-19.md) · [Open publication tasks](https://github.com/yogesh0224/shadowleak/issues) · [Phase-1 positioning draft PR #4](https://github.com/yogesh0224/shadowleak/pull/4).
>
