...
> **Publication progress and two distinct studies (2026-09-19):** The frozen primary and three replication model runs are complete and their **7,440 model-generation cases** have passed a metadata-only evidence audit (zero recorded generation failures). The original archives still require durable private preservation; a collision-free pooled annotation package has been generated and structurally checked in a temporary workspace, but private archival/handoff and **independent double annotation and adjudication** remain pending. The owner is working solo, so a **separate prospective 10-record/620-case single-annotator exploratory pilot** is now proposed; it has **not** been executed or labeled and does **not** complete the frozen two-human confirmatory protocol. No gold-label leakage rate, defense-effect estimate, final manuscript, or publication is yet established.
>
> **Track the work:** [Current publication status](docs/PUBLICATION_STATUS.md) · [Solo exploratory protocol and claim register](docs/SOLO_EXPLORATORY_PROTOCOL_V1.md) · [Publication roadmap](docs/RESEARCH_ROADMAP.md) · [Blinded annotation handoff](docs/ANNOTATION_HANDOFF.md) · [Artifact audit and SHA-256 digests](docs/CONFIRMATORY_ARTIFACT_AUDIT_2026-09-19.md) · [Open publication tasks](https://github.com/yogesh0224/shadowleak/issues) · [Phase-1 positioning draft PR #4](https://github.com/yogesh0224/shadowleak/pull/4).
>
> **Evidence preservation deadline:** The original GitHub Actions archives are reported to expire **2026-10-12**. Store unchanged copies in durable private storage; do not commit unblinded model responses or annotation keys to this public repository.
